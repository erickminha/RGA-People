-- Versão ajustada para ignorar FK de auth.users apenas para os dados fictícios
-- Empresa RGA (ID: 00000000-0000-0000-0000-000000000001)

-- Temporariamente desabilitar triggers que podem exigir auth.uid()
...
-- 2. Criar Perfis Fictícios (IDs manuais para evitar FK check de auth.users no modo demo)
-- Nota: Em produção a FK é essencial, mas aqui queremos apenas "ver" os dados na tabela
