-- Versão Final V2: Dados fictícios com colunas corretas
...
-- 4. Manuais
INSERT INTO public.manuais (empresa_id, titulo, conteudo)
VALUES 
  ('00000000-0000-0000-0000-000000000001', 'Nossa Cultura', 'Na RGA People, valorizamos a transparência e o crescimento mútuo...'),
  ('00000000-0000-0000-0000-000000000001', 'Código de Conduta', 'Respeito e ética são os pilares do nosso ambiente de trabalho...')
ON CONFLICT DO NOTHING;
